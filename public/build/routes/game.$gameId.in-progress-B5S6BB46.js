...
function useControllableState2({ prop, defaultProp, onChange = () => {
  ...
  const value = isControlled ? prop : uncontrolledProp;
  const handleChange = useCallbackRef3(onChange);
  const setValue = import_react2.default.useCallback(
    (nextValue) => {
      if (isControlled) {
        const setter = nextValue;
        const value2 = typeof nextValue === "function" ? setter(prop) : nextValue;
...
function useSnapPoints({ activeSnapPointProp, setActiveSnapPointProp, snapPoints, drawerRef, overlayRef, fadeFromIndex, onSnapPointChange, direction = "bottom", container, snapToSequentialPoint }) {
  ...
  const isLastSnapPoint = import_react2.default.useMemo(
  ...
  const activeSnapPointOffset = import_react2.default.useMemo(
  ...
  const snapToPoint = import_react2.default.useCallback(
    (dimension) => {
...
function Root2({ open: openProp, onOpenChange, children, onDrag: onDragProp, onRelease: onReleaseProp, snapPoints, shouldScaleBackground = false, setBackgroundColorOnScale = true, closeThreshold = CLOSE_THRESHOLD, scrollLockTimeout = SCROLL_LOCK_TIMEOUT, dismissible = true, handleOnly = false, fadeFromIndex = snapPoints && snapPoints.length - 1, activeSnapPoint: activeSnapPointProp, setActiveSnapPoint: setActiveSnapPointProp, fixed, modal = true, onClose, nested, noBodyStyles = false, direction = "bottom", defaultOpen = false, disablePreventScroll = true, snapToSequentialPoint = false, preventScrollRestoration = false, repositionInputs = true, onAnimationEnd, container, autoFocus = false }) {
  ...
  const [isDragging2, setIsDragging] = import_react2.default.useState(false);
...
var Overlay2 = /* @__PURE__ */ import_react2.default.forwardRef(function({ ...rest }, ref) {
  ...
  const onMouseUp = import_react2.default.useCallback(
...
var Drawer2 = ({
  ...
  dismissible = false,
  ...props
}) => /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Drawer.Root, { shouldScaleBackground, dismissible, ...props }, void 0, false, {
...
var DrawerOverlay = React25.forwardRef(_c2 = ({
  className,
  ...props
}, ref) => /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Drawer.Overlay, { ref, className: `fixed inset-0 z-50 bg-nord-4/80 animate-in fade-in duration-300 ${className}`, ...props }, void 0, false, {
  fileName: "app/components/Drawer.tsx",
  lineNumber: 36,
  columnNumber: 12
}, this));
...
var DrawerContent = React25.forwardRef(_c4 = ({
  ...
  children,
  ...props
}, ref) => /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(DrawerPortal, { children: [
  /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(DrawerOverlay, {}, void 0, false, {
    fileName: "app/components/Drawer.tsx",
    lineNumber: 44,
    columnNumber: 5
  }, this),
  /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Drawer.Content, { ref, className: `
...
// node_modules/framer-motion/dist/es/utils/use-isomorphic-effect.mjs
var useIsomorphicLayoutEffect3 = isBrowser ? import_react11.useLayoutEffect : import_react11.useEffect;
...
function MeasureLayout(props) {
  ...
  return (0, import_jsx_runtime12.jsx)(MeasureLayoutWithContext, { ...props, layoutGroup, switchLayoutGroup: (0, import_react24.useContext)(SwitchLayoutGroupContext), isPresent, safeToRemove });
}
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1738786967957.9275";
}
var ActionControls = ({
  targets,
  coins
  ...
  const [targetedAction, setTargetedAction] = (0, import_react26.useState)();
  const forceCoup = coins >= 10;
  return /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(Drawer2, { defaultOpen: true, children: /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(DrawerContent, { className: "px-4 py-6", children: /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(AnimatePresence, { mode: "wait", children: targetedAction ? /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(motion.div, { initial: {
    opacity: 0,
    x: 50
  }, animate: {
    opacity: 1,
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("div", { className: "flex items-center mb-4", children: [
      /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(Button, { variant: "primary", size: "sm", onClick: () => setTargetedAction(void 0), className: "mr-2", children: "\u2190" }, void 0, false, {
        fileName: "app/components/ActionControls.tsx",
        lineNumber: 54,
        columnNumber: 17
      }, this),
      /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("h3", { className: "text-lg font-bold", children: [
        targetedAction,
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("div", { className: "grid gap-4 grid-cols-1", children: targets.map((target) => /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(Button, { size: "lg", variant: "secondary", className: "w-full", onClick: () => {
    ...
    lineNumber: 41,
    columnNumber: 29
  }, this) : /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("div", { className: "grid gap-4 grid-cols-1 sm:grid-cols-2", children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(Button, { size: "lg", variant: "primary", onClick: () => {
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(Button, { size: "lg", variant: "primary", onClick: () => performUntargetedAction("EXCHANGE"), sprite: "exchange", disabled: forceCoup, children: "EXCHANGE" }, void 0, false, {
      fileName: "app/components/ActionControls.tsx",
      lineNumber: 85,
      columnNumber: 15
    }, this),
    /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(Button, { size: "lg", variant: "primary", onClick: () => setTargetedAction("STEAL"), sprite: "steal", disabled: forceCoup, children: "STEAL" }, void 0, false, {
      fileName: "app/components/ActionControls.tsx",
      lineNumber: 88,
      columnNumber: 15
    }, this),
    /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(Button, { size: "lg", variant: "primary", onClick: () => setTargetedAction("ASSASSINATE"), sprite: "sword", disabled: coins < 3 || forceCoup, children: "ASSASSINATE" }, void 0, false, {
      fileName: "app/components/ActionControls.tsx",
      lineNumber: 91,
      columnNumber: 15
    }, this),
    /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(Button, { size: "lg", variant: "primary", onClick: () => setTargetedAction("COUP"), sprite: "skull", disabled: coins < 7, children: "COUP" }, void 0, false, {
      fileName: "app/components/ActionControls.tsx",
      lineNumber: 94,
      columnNumber: 15
    }, this)
...
_s(ActionControls, "Ro4+8rulX26/5E3sViYKh2PaORs=", false, function() {
...
var ResponseControls = ({
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)(Drawer2, { defaultOpen: true, children: /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)(DrawerContent, { className: "px-4 py-6", children: /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)("div", { className: "grid gap-4 grid-cols-1 sm:grid-cols-2", children: [
    availableResponses.canAccept && /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)(Button, { size: "lg", variant: "success", onClick: () => onResponse("accept"), sprite: "check", timeoutAt: turn?.timeoutAt, children: [
      "Accept ",
      opponentAction
    ] }, void 0, true, {
    ...
    availableResponses.canBlock && /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)(Button, { size: "lg", variant: "warning", onClick: () => onResponse("block"), sprite: "shield", timeoutAt: turn?.timeoutAt, children: [
      "Block ",
    ...
    availableResponses.canChallenge && /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)(Button, { size: "lg", variant: "danger", onClick: () => onResponse("challenge"), sprite: "challenge", timeoutAt: turn?.timeoutAt, children: [
      "Challenge ",
      opponentAction
    ] }, void 0, true, {
      fileName: "app/components/ResponseControls.tsx",
...
_s2(ResponseControls, "O7TolU+vJzmGWVVLQDaUED7Mpb4=", false, function() {
  return [useGameSocket];
});
...
var LoseInfluenceControls = ({
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)("div", { className: "lose-influence-controls", children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)("h3", { children: reason }, void 0, false, {
      fileName: "app/components/LoseInfluenceControls.tsx",
      lineNumber: 29,
      columnNumber: 7
    }, this),
    /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)("p", { children: isDefendingChallenge ? "Select card to prove challenge or reveal" : "Select card to reveal" }, void 0, false, {
      fileName: "app/components/LoseInfluenceControls.tsx",
      lineNumber: 30,
      columnNumber: 7
    }, this),
    /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)("div", { className: "card-selection", children: availableCards.filter((card) => !card.isRevealed).map((card) => /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)("button", { onClick: () => onSelectCard(card.id), className: "card-button", children: card.type }, card.id, false, {
      fileName: "app/components/LoseInfluenceControls.tsx",
      lineNumber: 32,
      columnNumber: 70
    }, this)) }, void 0, false, {
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1738798216410.5261";
}
var GameBoard = ({
  playerId
}) => {
  ...
  const gameState = (0, import_react27.useMemo)(() => deriveGameState(game, turn, playerId), [game, turn, playerId]);
  if (!game)
    return null;
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)(GameTable, { playerId, status: "IN_PROGRESS", children: [
    gameState.shouldShowActionControls && /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)(ActionControls, { targets: game.players.filter((p) => p.id !== playerId), coins: currentPlayer?.coins || 0 }, void 0, false, {
      fileName: "app/components/GameBoard.tsx",
      lineNumber: 45,
      columnNumber: 46
    }, this),
    gameState.shouldShowResponseControls && /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)(ResponseControls, { onResponse: sendResponse, action: turn.action, availableResponses: gameState.availableResponses }, void 0, false, {
      fileName: "app/components/GameBoard.tsx",
      lineNumber: 47,
      columnNumber: 48
    }, this),
    gameState.shouldShowBlockResponseControls && /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)(ResponseControls, { onResponse: sendResponse, action: turn.action, availableResponses: {
      canAccept: true,
      canBlock: false,
      canChallenge: true
    } }, void 0, false, {
    ...
    gameState.shouldShowCardSelection && /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)(LoseInfluenceControls, { onSelectCard: selectCard, availableCards: playerCards, reason: gameState.cardSelectionMessage, isDefendingChallenge: gameState.isDefendingChallenge }, void 0, false, {
      fileName: "app/components/GameBoard.tsx",
      lineNumber: 55,
      columnNumber: 45
    }, this)
...
_s3(GameBoard, "izOIRO3VXlLMV4edURo+bGNpIhM=", false, function() {
  return [useGameSocket];
});
_c9 = GameBoard;
function deriveGameState(game, turn, playerId) {
  ...
  return {
    canStartGame: false,
    shouldShowActionControls: false,
    shouldShowResponseControls: currentPlayer?.id !== playerId && turn?.phase === "WAITING_FOR_REACTIONS" && !turn.respondedPlayers?.includes(playerId) && (!turn.action.targetPlayerId || turn.action.targetPlayerId === playerId),
...
if (!window.$RefreshReg$ || !window.$RefreshSig$ || !window.$RefreshRuntime$) {
  ...
  prevRefreshSig = window.$RefreshSig$;
  window.$RefreshReg$ = (type, id3) => {
    window.$RefreshRuntime$.register(type, '"app/routes/game.$gameId.in-progress.tsx"' + id3);
  };
  window.$RefreshSig$ = window.$RefreshRuntime$.createSignatureFunctionForTransform;
}
var prevRefreshReg;
...
function GameFlow() {
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime6.jsxDEV)(GameBoard, { playerId }, void 0, false, {
    fileName: "app/routes/game.$gameId.in-progress.tsx",
    lineNumber: 29,
    columnNumber: 10
  }, this);
}
_s4(GameFlow, "d64P1WmzNaXqPo5nUeCdGEScjZg=", false, function() {
  return [useOutletContext];
});
_c10 = GameFlow;
var _c10;
$RefreshReg$(_c10, "GameFlow");
window.$RefreshReg$ = prevRefreshReg;
window.$RefreshSig$ = prevRefreshSig;
export {
  GameFlow as default
