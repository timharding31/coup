    ...
    <TooltipProvider>
      <Tooltip open={isPopoverOpen}>
        <TooltipTrigger asChild>
          <div
            className={`flex flex-col items-center justify-center gap-2 rounded-xl duration-500 ${isPopoverOpen ? `outline-2 outline-offset-4 outline-${accentColor} outline` : ''}`}
          >
